    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movieid', models.ForeignKey(to='phase2.MlMovies')),
            ],
        ),
        migrations.CreateModel(
            name='MlTags',
            fields=[
                ...
                ('norm_weight', models.FloatField(default=0.0, db_index=True, blank=True)),
                ('movieid', models.ForeignKey(to='phase2.MlMovies')),
                ('tagid', models.ForeignKey(to='phase2.GenomeTags')),
            ],
        ),
        migrations.CreateModel(
            name='MlUsers',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actorid', models.ForeignKey(to='phase2.ImdbActorInfo')),
                ('movieid', models.ForeignKey(to='phase2.MlMovies')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='mltags',
            name='userid',
            field=models.ForeignKey(to='phase2.MlUsers'),
        ),
        migrations.AddField(
