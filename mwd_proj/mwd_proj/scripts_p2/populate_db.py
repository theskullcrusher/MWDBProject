...
def populate_db():
	...
	try:
		...
		with open("../dataset_p2/genome-tags.csv","rb") as f:
			rows = csv.reader(f)
		...
		with open("../dataset_p2/imdb-actor-info.csv","rb") as f:
			rows = csv.reader(f)
			for n, row in enumerate(rows):
				if n == 0:
					print row
		...
		with open("../dataset_p2/mlmovies.csv","rb") as f:
			rows = csv.reader(f)
			for n, row in enumerate(rows):
				if n == 0:
					print row
		...
		with open("../dataset_p2/mlusers.csv","rb") as f:
			rows = csv.reader(f)
			for n, row in enumerate(rows):
				if n == 0:
					print row
		...
		with open("../dataset_p2/movie-actor.csv","rb") as f:
			rows = csv.reader(f)
			for n, row in enumerate(rows):
				if n == 0:
					print row
		...
		with open("../dataset_p2/mltags.csv","rb") as f:
			rows = csv.reader(f)
			for n, row in enumerate(rows):
				if n == 0:
					print row
		...
		with open("../dataset_p2/mlratings.csv","rb") as f:
			rows = csv.reader(f)
			for n, row in enumerate(rows):
				if n == 0:
					print row
